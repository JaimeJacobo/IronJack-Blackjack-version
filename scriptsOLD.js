    ...
    hit(){
        ...
        let randomCard = Math.floor(Math.random()*this.deckOfCards.length);
        ...
        // pushedCard;
            ...
            this.playerCount += pushedCard.value;
...
$("#dealButton").click(function(){
    ...
    if(player.totalBet > 0){
        ...
        $("#dealerCardsDiv").prepend('<p>' + getCardImage(player.dealerHand[0].name) + '</p>');

        $("#playerCardsDiv").prepend('<p>' + getCardImage(player.playerHand[0].name) + '</p>' + '<p>' + getCardImage(player.playerHand[1].name) + '</p>');
